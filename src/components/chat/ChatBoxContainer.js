...
export default function ChatBoxContainer({ item }) {
    ...
    const [messages, setMessages] = useState([
        ...
        { id: 3, text: "Of course! React hooks are functions that let you use state and lifecycle features in functional components. What specific hook would you like to learn about?", sender: "system", timestamp: new Date() }
    ]);
